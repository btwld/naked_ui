...
- [x] B1 smoke and B2 real-macOS job implemented; local macOS drive is green
...
All Phase 0 implementation tasks are complete in the working tree. GitHub-hosted
workflow execution (especially Android, for which no local emulator is
installed) remains post-push evidence and was not attempted because this work
was explicitly requested without a commit or PR.
