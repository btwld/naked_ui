---
title: NakedSwitch
description: Headless switch component for Flutter settings and preferences with proper ARIA switch semantics
keywords: [flutter, switch, toggle, settings, preferences, headless, accessibility, ARIA, on-off]
---
...
<Note>
  NakedSwitch is actually implemented using NakedToggle with `asSwitch: true`. This ensures proper accessibility semantics for on/off controls like settings and preferences.
</Note>
