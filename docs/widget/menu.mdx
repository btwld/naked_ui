...
`NakedMenu` anchors an overlay to any widget and handles focus, keyboard navigation, outside-click dismissal, and accessibility without shipping visuals. Supply a trigger builder (or child), render whatever overlay you need, and use the typed state structures to style active or hovered items.
  ...
  Widget build(BuildContext context) {
    return NakedMenu<String>(
      ...
      builder: (context, menuState, _) {
        ...
        final bool isHovered = menuState.isHovered;
...
- `widgetStates` → hover/focus/pressed/disabled states exposed in the builder (`menuState.isHovered`, `menuState.isPressed`, etc.)
