...
#### builder → `NakedStateBuilder<NakedButtonState>?`
Optional builder that receives the current [NakedButtonState] to drive visuals. Use this instead of callbacks for stateless widgets.
