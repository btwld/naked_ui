...
#### semanticHint → `String?`
Optional semantic hint for accessibility. Helps screen readers describe slider interactions.
...
#### enableFeedback → `bool`
Whether to provide platform-specific feedback on keyboard navigation. Defaults to true.

#### excludeSemantics → `bool`
Whether to exclude the child’s semantics subtree. Defaults to false.
