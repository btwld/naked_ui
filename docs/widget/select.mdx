...
Optional semantic label announced by screen readers on the trigger.
...
#### enableFeedback → `bool`
Whether to provide feedback when tapped. Defaults to true.
...
#### onSelectChange → `ValueChanged<bool>?`
