...
NakedRadio provides interaction behavior and accessibility features without imposing any visual styling, giving complete design freedom. It must be used within a NakedRadioGroup to function properly.
