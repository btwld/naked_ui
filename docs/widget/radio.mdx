...
<Info>
  You can find this example in our [GitHub repository](https://github.com/btwld/naked_ui/blob/main/example/lib/api/naked_radio.0.dart).
</Info>
...
<!-- No external states controller; NakedRadio reports states via builder and callbacks. -->
