...
title: NakedCheckbox
---
NakedCheckbox provides core interaction behavior and accessibility without imposing any visual styling, giving consumers complete design freedom. It integrates with `NakedFocusableDetector` to provide enhanced keyboard accessibility, hover detection, and focus management.
