...
`NakedTooltip` wires up a popover that appears on hover/focus and hides after a delay. Provide the trigger child (and optional trigger builder) plus an overlay builder for the tooltip content; the widget manages timers, positioning, and focus dismissal.
