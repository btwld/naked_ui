...
void main() {
  ...
  group('NakedAccordion Integration Tests', () {
    testWidgets('accordion expands and collapses correctly', (tester) async {
      ...
      expect(find.text('This is the content for section 1. You can put anything here!'), findsOneWidget);
      expect(find.text('This is the content for section 2. You can put anything here!'), findsNothing);
      ...
      expect(find.text('This is the content for section 1. You can put anything here!'), findsNothing);
      expect(find.text('This is the content for section 2. You can put anything here!'), findsOneWidget);
    ...
    testWidgets('accordion item state callbacks work correctly', (tester) async {
      final controller = NakedAccordionController<String>();
