...
class _SliderIntentActions {
  ...
  Map<Type, Action<Intent>> actions({
    ...
    return {
      ...
      _SliderShiftIncrementIntent: _SliderAdjustAction<_SliderShiftIncrementIntent>(
        onChanged: onChanged,
        calculateStep: calculateStep,
        normalizeValue: normalizeValue,
        getCurrentValue: () => currentValue,
      ...
      _SliderShiftDecrementIntent: _SliderAdjustAction<_SliderShiftDecrementIntent>(
        onChanged: onChanged,
        calculateStep: calculateStep,
        normalizeValue: normalizeValue,
        getCurrentValue: () => currentValue,
